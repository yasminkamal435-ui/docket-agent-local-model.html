...
export const I18N = {
  ar: {
    ...
    nav: { home: 'الرئيسية', predict: 'توقّع السعر', compare: 'مقارنة شقق', dashboard: 'لوحة البيانات', chat: 'المساعد الذكي', photo: 'تحليل صورة', training: 'درّبي الموديل' },
    hero: {
    ...
    chat: {
      title: 'المساعد الذكي المتخصص (Qwen2.5-0.5B-Instruct — موديل جاهز)',
      ...
      loading: 'بيتحمّل الموديل اللغوي الذكي (~300-400 ميجا، أول مرة بس، هيتخزّن بعد كده)…',
    ...
    training: {
      title: 'درّبي موديل حقيقي دلوقتي في المتصفح',
      sub: 'الجزء ده مختلف عن باقي الصفحة: هنا موديل شبكة عصبية بيتدرب فعليًا من الصفر (أوزان عشوائية) على بيانات شقق تركيبية بتتولّد لحظيًا، خطوة بخطوة، وشايفة الخطأ (Loss) بينزل مع كل Epoch لحد ما الموديل "يتعلّم". ده تدريب حقيقي بيحصل جوّه جهازك دلوقتي، مش نتيجة محفوظة من قبل.',
